...
>
> Verwenden Sie [dieses GitHub-Problem](https://github.com/dotnet/AspNetDocs/issues/116) , um Probleme mit dem Microsoft AJAX CDN zu melden.
...
Das Microsoft AJAX Content Delivery Network (CDN) hostet beliebte JavaScript-Bibliotheken von Drittanbietern, z. b. jQuery, und ermöglicht es Ihnen, Sie problemlos zu Ihren Webanwendungen hinzuzufügen. Beispielsweise können Sie mit der Verwendung von jQuery beginnen, das in diesem CDN gehostet wird. Fügen Sie &lt; &gt; dazu der Seite, die auf AJAX.aspnetcdn.com verweist, ein Skripttag hinzu.
...
- jQuery-Benutzeroberfläche (www.jqueryui.com)
...
- Die jQuery UI Library die jQuery UI &mdash; Library enthält alle jQuery-Benutzeroberflächen Effekte und-Widgets, wie z. b. das DatePicker-Widget, das auf der obigen Seite verwendet wird.
- Ein jQuery UI-Design &mdash; der jQuery-Benutzeroberfläche unterstützt verschiedene Designs. Die obige Seite enthält einen Link zu einer CSS-Datei, um das Redmond-Design zu importieren.
...
#### <a name="jquery-version-340"></a>jQuery-Version 3.4.0
...
- [jQuery Validate 1.19.2](jquery-validate/cdnjqueryvalidate1192.md "jQuery-Validierung 1.19.2")
...
Die folgenden Releases von [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js Releases werden im CDN gehostet:
