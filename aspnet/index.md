...
ms.locfileid: "78419775"
---
<!-- markdownlint-disable MD033 -->
<div id="main" class="v2">
    <div class="container">
        <h1>ASP.NET Core-Dokumentation</h1>
        <ul class="pivots">
            <li>
                <a href="#core">ASP.NET Core</a>
                <ul id="core">
                    <li>
                        <a href="#core_overview">Übersicht</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Erste Schritte mit ASP.NET Core</h3>
                                                    <p>Erstellen Sie Ihre erste ASP.NET Core-App auf einer beliebigen Plattform innerhalb von 5 Minuten.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Einführung in ASP.NET Core</h3>
                                                    <p>Lernen Sie die neuen Konzepte in ASP.NET Core kennen, und erfahren Sie, wie diese Konzepte Sie bei der Entwicklung moderner Web-Apps unterstützen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>API-Referenz</h3>
                                                    <p>Erkunden Sie die ASP.NET Core-Klassenbibliothek.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Übersicht über ASP.NET Core MVC</h3>
                                                    <p>Erfahren Sie, wie Sie Web-Apps und APIs mithilfe der MVC-Entwurfsmuster entwickeln.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Grundlagen</h3>
                                                    <p>Lernen Sie die Grundlagen von ASP.NET Core kennen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Lernen Sie in kostenfreien Kursen verschiedener Schulungsanbieter, wie Sie Anwendungen mit ASP.NET Core entwickeln.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="core_tutorials" class="cardsZ">
                            <li>
                                <div class="container intro">
                                    <p>Ausgewählte Tutorials | <a href="https://docs.microsoft.com/aspnet/core/tutorials/" data-raw-source="[View all ASP.NET Core tutorials](https://docs.microsoft.com/aspnet/core/tutorials/)">Alle ASP.NET Core-Tutorials anzeigen</a></p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Entwickeln einer Website unter Mac</h3>
                                                    <p>Entwickeln Sie Ihre erste ASP.NET Core-App unter Mac mithilfe von Visual Studio für Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Entwickeln einer Website mit Visual Studio unter Windows</h3>
                                                    <p>Entwickeln Sie Ihre erste ASP.NET Core MVC-App mit Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Entwickeln einer Web-API</h3>
                                                    <p>Entwickeln Sie Ihre erste Web-API mit ASP.NET Core MVC und Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Erste Schritte mit Entity Framework Core und ASP.NET Core</h3>
                                                    <p>Erstellen Sie ASP.NET Core MVC-Webanwendungen, die Entity Framework Core für den Datenzugriff verwenden.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET-Web-API-Hilfeseiten mit Swagger</h3>
                                                    <p>Generieren Sie mithilfe von Swagger und Swashbuckle eine Dokumentation und Hilfeseiten für die ASP.NET-Web-API.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bereitstellen einer ASP.NET Core-Web-App in Azure mit Visual Studio</h3>
                                                    <p>Erstellen Sie eine Web-App in Azure App Service, und stellen Sie eine zugehörige ASP.NET Core-Web-App bereit.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                ...
                <ul id="aspnet">
                    <li>
                        <a href="#aspnet_overview">Übersicht</a>
                        <ul id="aspnet_overview" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>ASP.NET ist eine ausgereifte Webplattform, die alle Dienste umfasst, die zum Entwickeln serverbasierter Webanwendungen auf Unternehmensniveau unter Verwendung von .NET unter Windows erforderlich sind.</p>
                                    <p><a href="https://docs.microsoft.com/aspnet/core/choose-aspnet-framework" data-raw-source="[Learn the benefits of both ASP.NET Core and ASP.NET](https://docs.microsoft.com/aspnet/core/choose-aspnet-framework)">Lernen Sie die Vorteile von ASP.NET Core und ASP.NET kennen</a>, und wählen Sie das für Sie geeignete Framework aus.</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Herunterladen von Visual Studio</h3>
                                                    <p>Visual Studio ist eine kostenlose IDE für ASP.NET unter Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Einführung in ASP.NET</h3>
                                                    <p>Vergleichen Sie die ASP.NET-Technologien für das Entwickeln von Webanwendungen und Web-APIs sowie für das Hinzufügen von Echtzeitfunktionalität.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET-API-Referenz</h3>
                                                    <p>Erkunden Sie die ASP.NET-Klassenbibliothek.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Websites</h3>
                                                    <p>Erfahren Sie, wie Sie eine Website mithilfe von ASP.NET MVC 5 und Visual Studio entwickeln.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web-APIs</h3>
                                                    <p>Erfahren Sie, wie Sie eine Web-API mithilfe von ASP.NET-Web-API 2 und Visual Studio entwickeln.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Kostenlose Kurse</h3>
                                                    <p>Lernen Sie in kostenfreien Kursen verschiedener Schulungsanbieter, wie Sie Anwendungen mit ASP.NET entwickeln.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li class="fullSpan">
                                <div class="container footer">
                                    <p><a href="https://github.com/aspnet/Docs/blob/master/CONTRIBUTING.md">Zu ASP.NET-Dokumentation und -Beispielen beitragen</a></p>
                                </div>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="aspnet_framework" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p><a href="/aspnet/overview#websites-and-web-applications">Lernen Sie die verschiedenen Optionen für die Websiteentwicklung mit ASP.NET kennen</a>, und wählen Sie die für Sie geeignete Option aus.</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web Forms</h3>
                                                    <p>Entwickeln Sie dynamische Websites mithilfe eines vertrauten, ereignisgesteuerten Drag & Drop-Modells.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MVC</h3>
                                                    <p>Eine leistungsstarke, auf Mustern basierende Methode zum Entwickeln dynamischer Websites, die eine saubere Trennung von Zuständigkeiten ermöglicht.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Webseiten</h3>
                                                    <p>Eine schnelle, bedienerfreundliche und einfache Methode zum Kombinieren von Servercode mit HTML für das Erstellen von dynamischem Webinhalt.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web-API</h3>
                                                    <p>Erstellen Sie auf einfache Weise HTTP-Dienste für eine breit gefächerte Palette von Clients, darunter auch Browser und mobile Geräte.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>WebHooks</h3>
                                                    <p>Kombinieren Sie Web-APIs und SaaS-Dienste unter Verwendung eines schlanken HTTP-Musters, das ein einfaches Modell für Veröffentlichung und Abonnierung bereitstellt.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SignalR</h3>
                                                    <p>Fügen Sie Ihren Anwendungen Echtzeitwebfunktionalität hinzu.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="aspnet_tutorials" class="cardsZ">
                            <li>
                                <div class="container intro">
                                    <p>Ausgewählte Tutorials | <a href="https://docs.microsoft.com/aspnet/tutorials/" data-raw-source="[View all ASP.NET tutorials](https://docs.microsoft.com/aspnet/tutorials/)">Alle ASP.NET-Tutorials anzeigen</a></p>
                                </div>
                            </li>
                            <li>
                                <a href="https://docs.microsoft.com/aspnet/mvc/overview/getting-started/introduction/getting-started">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Erste Schritte mit ASP.NET MVC 5</h3>
                                                    <p>Dieses Tutorial vermittelt Ihnen die Grundlagen zum Entwickeln einer ASP.NET MVC 5-Web-App mithilfe von Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Erste Schritte mit ASP.NET-Web-API 2</h3>
                                                    <p>Dieses Tutorial vermittelt Ihnen die Grundlagen zum Entwickeln einer Web-API unter Verwendung von ASP.NET-Web-API 2 und Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Erste Schritte mit SignalR 2</h3>
                                                    <p>Dieses Tutorial zeigt, wie Sie mithilfe von SignalR eine Chatanwendung mit Echtzeitfunktionalität erstellen.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Erste Schritte mit Entity Framework 6 Code First unter Verwendung von MVC 5</h3>
                                                    <p>Die Grundlagen der Verwendung von Entity Framework 6 zur Anzeige und Bearbeitung von Daten in einer ASP.NET MVC 5-Anwendung.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migrieren von ASP.NET MVC-Anwendungen zu Windows-Containern</h3>
                                                    <p>Erfahren Sie, wie Sie eine vorhandene ASP.NET MVC-Anwendung in einem Windows Docker-Container ausführen können.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
