...
---
# <a name="iteration-4--make-the-application-loosely-coupled-vb"></a>Iteration 4 – Loses Koppeln der Anwendung (VB)

von [Microsoft](https://github.com/microsoft)

[Code herunterladen](iteration-4-make-the-application-loosely-coupled-vb/_static/contactmanager_4_vb1.zip)
...
**Auflisten 1 - Modelle-IContactManagerRepository.vb**
...
**Auflisten 2 - Modelle-EntityContactManagerRepository.vb**
...
**Auflisten 3 - Controller-KontaktController.vb**
...
**Auflisten 4 - Modelle-KontaktManagerService.vb**
...
**Auflisten 5 - Modelle-IContactManagerService.vb**
...
**Auflisten 6 - Controller-KontaktController.vb**
...
**Auflisten 7 - Modelle- "Validierung" und "ModelStateWrapper.vb"**

[!code-vb[Main](iteration-4-make-the-application-loosely-coupled-vb/samples/sample7.vb)]

**Auflistung 8 - Models-Validierung- und -IValidationDictionary.vb**
