...
title: Anzeigen einer Tabelle mit Datenbankdaten | Microsoft Docs
...
ms.locfileid: "81542053"
---
# <a name="displaying-a-table-of-database-data-c"></a>Anzeigen einer Tabelle von Datenbankdaten (C#)

von [Microsoft](https://github.com/microsoft)

[PDF herunterladen](https://download.microsoft.com/download/1/1/f/11f721aa-d749-4ed7-bb89-a681b68894e6/ASPNET_MVC_Tutorial_11_CS.pdf)
...
[![Erstellen von LINQ-zu-SQL-Klassen](displaying-a-table-of-database-data-cs/_static/image1.jpg)](displaying-a-table-of-database-data-cs/_static/image1.png)

**Abbildung 01**: Erstellen von LINQ-zu-SQL-Klassen ([Klicken Sie hier, um das Bild in voller Größe anzuzeigen](displaying-a-table-of-database-data-cs/_static/image2.png))
...
**Abbildung 02**: Der Entity Data Model Designer ([Klicken Sie hier, um das Bild in voller Größe anzuzeigen](displaying-a-table-of-database-data-cs/_static/image4.png))
...
[![Das Menü Controller hinzufügen](displaying-a-table-of-database-data-cs/_static/image3.jpg)](displaying-a-table-of-database-data-cs/_static/image5.png)

**Abbildung 03**: Das Menü Controller hinzufügen ([Klicken Sie hier, um das Bild in voller Größe anzuzeigen](displaying-a-table-of-database-data-cs/_static/image6.png))
...
**Abbildung 04**: Das Dialogfeld Controller hinzufügen([Klicken Sie hier, um das Bild in voller Größe anzuzeigen)](displaying-a-table-of-database-data-cs/_static/image8.png)
...
**Auflisten 1 – Controller-MovieController.cs**

[!code-csharp[Main](displaying-a-table-of-database-data-cs/samples/sample1.cs)]

In Listing 1 wird die MoviesDBEntities-Klasse verwendet, um die MoviesDB-Datenbank darzustellen. Um diese Klasse zu verwenden, müssen Sie den Namespace MvcApplication1.Models wie folgt importieren:

Verwenden von MvcApplication1.Models;

Die *Ausdrucksentitäten. MovieSet.ToList()* gibt den Satz aller Filme aus der Tabelle Movies-Datenbank zurück.
...
**Abbildung 05**: Hinzufügen einer Ansicht ([Klicken Sie hier, um das Bild in voller Größe anzuzeigen](displaying-a-table-of-database-data-cs/_static/image10.png))
...
**Abbildung 06**: Das Dialogfeld Ansicht hinzufügen([Klicken Sie hier, um das Bild in voller Größe anzuzeigen)](displaying-a-table-of-database-data-cs/_static/image12.png)
...
[![Eine Tabelle mit Filmen](displaying-a-table-of-database-data-cs/_static/image7.jpg)](displaying-a-table-of-database-data-cs/_static/image13.png)

**Abbildung 07**: Eine Tabelle mit Filmen ([Klicken Sie hier, um das Bild in voller Größe anzuzeigen](displaying-a-table-of-database-data-cs/_static/image14.png))
...
Die Ansicht in Listing 4 enthält eine Foreach-Schleife, die durch alle Filme iteriert. Für jeden Film wird der MovieTemplate-Teil teilteil verwendet, um den Film zu formatieren. Die MovieTemplate wird gerendert, indem die RenderPartial()-Hilfsmethode aufgerufen wird.
...
Die RenderPartial()-Methode unterscheidet sich von den meisten anderen Hilfsmethoden, da keine Zeichenfolge zurückgegeben wird. Daher müssen Sie die RenderPartial()-Methode mit &lt;% Html.RenderPartial() aufrufen. %&gt; statt &lt;%= Html.RenderPartial(); %&gt;.
