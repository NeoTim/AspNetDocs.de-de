...
title: Validierung mit den Datenanmerkungsvalidierern | Microsoft Docs
...
ms.locfileid: "81542676"
---
# <a name="validation-with-the-data-annotation-validators-c"></a>Überprüfung der Validierungssteuerelemente für Datenanmerkungen (C#)
...
**Abbildung 1:** Hinzufügen eines Verweises auf den Modellbinder für Datenanmerkungen ([Klicken Sie hier, um das Bild in voller Größe anzuzeigen](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
Diese Codezeile registriert den ataAnnotationsModelBinder als Standardmodellbinder für die gesamte ASP.NET MVC-Anwendung.
...
**Auflistung 1**: Models-Produkt.cs
...
**Abbildung 6:** Verwenden von Validatoren mit dem Entity Framework ([Klicken Sie hier, um das Bild in voller Größe anzuzeigen](validation-with-the-data-annotation-validators-cs/_static/image14.png))
