...
[![Dialog Feld für neues Projekt](understanding-models-views-and-controllers-vb/_static/image1.jpg)](understanding-models-views-and-controllers-vb/_static/image1.png)

**Abbildung 01**: Dialog Feld "Neues Projekt" ([Klicken Sie, um das Bild in voller Größe anzuzeigen](understanding-models-views-and-controllers-vb/_static/image2.png))
...
[![Dialog Feld "Komponenten Test erstellen"](understanding-models-views-and-controllers-vb/_static/image2.jpg)](understanding-models-views-and-controllers-vb/_static/image3.png)

**Abbildung 02**: Dialog Feld "Komponenten Test erstellen" ([Klicken Sie, um das Bild in voller Größe anzuzeigen](understanding-models-views-and-controllers-vb/_static/image4.png))
...
Wenn Sie den Ordner "Controllers" erweitern, sollte eine Datei mit dem Namen "AccountController. vb" und eine Datei mit dem Namen "HomeController. vb" angezeigt werden. Wenn Sie den Ordner "Views" erweitern, sollten drei Unterordner namens "Account", "Home" und "Shared" angezeigt werden. Wenn Sie den Basisordner erweitern, sehen Sie zwei weitere Dateien mit den Namen "about. aspx" und "index. aspx" (siehe Abbildung 3). Diese Dateien bilden die Beispielanwendung, die in der standardmäßigen ASP.NET-MVC-Vorlage enthalten ist.

[![Das Projektmappen-Explorer Fenster](understanding-models-views-and-controllers-vb/_static/image3.jpg)](understanding-models-views-and-controllers-vb/_static/image5.png)

**Abbildung 03**: das Fenster "Projektmappen-Explorer" ([Klicken Sie, um das Bild in voller Größe anzuzeigen](understanding-models-views-and-controllers-vb/_static/image6.png))
...
[![Dialogfeld "Debugging nicht aktiviert"](understanding-models-views-and-controllers-vb/_static/image4.jpg)](understanding-models-views-and-controllers-vb/_static/image7.png)

**Abbildung 04**: Dialogfeld "Debuggen deaktiviert" ([Klicken Sie, um das Bild in voller Größe anzuzeigen](understanding-models-views-and-controllers-vb/_static/image8.png))
...
[![Die Index Seite](understanding-models-views-and-controllers-vb/_static/image5.jpg)](understanding-models-views-and-controllers-vb/_static/image9.png)

**Abbildung 05**: die Index Seite ([Klicken Sie, um das Bild in voller Größe anzuzeigen](understanding-models-views-and-controllers-vb/_static/image10.png))
...
Ein Controller ist nur eine Klasse (z. b. eine Visual Basic-oder c#-Klasse). Die MVC-Beispielanwendung enthält einen Controller mit dem Namen "HomeController. vb", der sich im Ordner "Controllers" befindet. Der Inhalt der Datei "HomeController. vb" wird in der Liste 2 reproduziert.
